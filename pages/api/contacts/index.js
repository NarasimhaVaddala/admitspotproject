...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    const [contacts] = await db.query(
      'SELECT * FROM contacts WHERE id = ? AND (name LIKE ? OR email LIKE ? OR timezone LIKE ?)',
    ...
    await db.query('INSERT INTO contacts (id, name, email, phone, address, timezone) VALUES (?, ?, ?, ?, ?, ?)', 
